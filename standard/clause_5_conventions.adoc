...
[[fig4]]
.Yellow Color Denotes Components
image::images/Yellow_UML.png[]

Classes painted in yellow correspond to components or have properties that are represented in components and in encodings of those components. Only data types and classes painted yellow are encoded as concrete data objects.
