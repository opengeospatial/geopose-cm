...
The GeoPose CM consists of linked definitions of terms denoting concepts expressed in the GeoPose LM and component specifications for the standardization targets.
...
* the normative derivation of specific components that represent abstract implementation and standardization targets.

These components are abstract: they are independent of implementation or delivery technology and serialization or encoding formats. 
