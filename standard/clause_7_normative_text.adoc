...
The coloring of the classes indicates their role in the logical design. Note that the classes and data types defined in the Target packages are the source of components that may be realized as concrete data objects.
...
The Basic-YPR, Basic-Quaternion, and the Advanced GeoPose components represent single GeoPose objects.
